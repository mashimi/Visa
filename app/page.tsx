          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-xl font-display font-bold text-white">Visa Interview Simulator</h1>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Our comprehensive platform combines AI technology with document analysis
              to give you the most realistic and effective interview preparation.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 mb-8">
            Join thousands of successful applicants who have used our platform to prepare
            and increase their chances of visa approval.
          </p>
          <Link href="/register">
            <Button size="lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center gap-3 mb-4 md:mb-0">
              ...
              <span className="text-white font-display font-bold">Visa Interview Simulator</span>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center text-sm text-gray-500">
            © 2024 Visa Interview Simulator. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
